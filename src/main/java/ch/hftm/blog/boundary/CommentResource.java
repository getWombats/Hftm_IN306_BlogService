...
//     public Uni<Response> getAllCommentsWithOptionalFiltering(@QueryParam("searchString") Optional<String> searchString,
...
//             .item(commentService.getAllCommentsWithOptionalFiltering(searchString, page).createHttpResponse())
