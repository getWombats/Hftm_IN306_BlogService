...
public class BlogPostResource extends ResourceBase {
    ...
    public Uni<List<BlogPostDTO>> getAllBlogPostsWithOptionalFiltering(@QueryParam("searchString") Optional<String> searchString,
        ...
        //     .item(blogService.getAllBlogPostsWithOptionalFiltering(searchString, page).createHttpResponse())
        //     .runSubscriptionOn(Infrastructure.getDefaultExecutor())
        //     .flatMap(response -> Uni.createFrom().item(response));

        // return blogService.getAllBlogPostsWithOptionalFiltering(searchString, page);
    ...
    // public Uni<Response> getBlogPostById(@PathParam("blogId") Long blogId) {
    //     if (blogId == null) {
    //         // return Response.status(Response.Status.BAD_REQUEST).entity(MISSING_BLOG_ID_IN_PATH_MESSAGE).build();
    //         return Uni.createFrom().item(Response.status(Response.Status.BAD_REQUEST).entity(MISSING_BLOG_ID_IN_PATH_MESSAGE).build());
    //     }
    //     // return blogService.getBlogById(blogId).createHttpResponse();

    //     return Uni.createFrom()
    //         .item(blogService.getBlogById(blogId).createHttpResponse())
    //         .runSubscriptionOn(Infrastructure.getDefaultExecutor())
    //         .flatMap(response -> Uni.createFrom().item(response));
    // }
    ...
    // public Uni<Response> addBlogPost(@Valid BlogPostDTO blogDTO, @Context UriInfo uriInfo) {
    //     ValidationResponse validationResponse = validationService.validateBlogContent(blogDTO.getContent());

    //     if (!validationResponse.valid()) {
    //         return Uni.createFrom().item(ResponseFactory.createValidationErrorResponse());
    //     }
    ...
    //     return Uni.createFrom().item(blogDTO)
    //         .runSubscriptionOn(Infrastructure.getDefaultExecutor())
    //         .flatMap(blog -> Uni.createFrom().item(blogService.addBlogPost(blog)))
    //         .map(savedPost -> savedPost.createHttpResponse(uriInfo));
    ...
    // public Uni<Response> deleteBlogPost(@PathParam("blogId") Long blogId) {
    //     if (blogId == null) {
    //         // return Response.status(Response.Status.BAD_REQUEST).entity(MISSING_BLOG_ID_IN_PATH_MESSAGE).build();
    //         return Uni.createFrom().item(Response.status(Response.Status.BAD_REQUEST).entity(MISSING_BLOG_ID_IN_PATH_MESSAGE).build());
    //     }
    ...
    //     return Uni.createFrom()
    //         .item(blogService.deleteBlogPost(blogId).createHttpResponse())
    //         .runSubscriptionOn(Infrastructure.getDefaultExecutor())
    //         .flatMap(response -> Uni.createFrom().item(response));
    // }
    ...
    //     return Uni.createFrom().item(ohNoAllBlogPostsAreGone ? Response.status(Response.Status.NO_CONTENT).build()
    //             : Response.status(Response.Status.INTERNAL_SERVER_ERROR).entity("Problem while deleting all blog posts.").build());
    // }
    ...
    // public Uni<Response> updateBlogPost(@Valid BlogPostDTO blogDTO) {
    //     if (blogDTO.getId() == null) {
    //         // return Response.status(Response.Status.BAD_REQUEST).entity("Missing Blog-ID.").build();
    //         return Uni.createFrom().item(Response.status(Response.Status.BAD_REQUEST).entity("Missing Blog-ID.").build());
    //     }
    ...
    //     return Uni.createFrom().item(blogDTO)
    //         .runSubscriptionOn(Infrastructure.getDefaultExecutor())
    //         .flatMap(blog -> Uni.createFrom().item(blogService.updateBlogPost(blog)))
    //         .map(updatedPost -> updatedPost.createHttpResponse());
    // }
    ...
    // public Uni<Response> replaceBlogPost(@PathParam("blogId") Long blogId, BlogPostDTO blogDTO) {
    ...
    // public Uni<Response> getAllCommentsFromBlogPost(@PathParam("blogId") Long blogId) {
    //     if (blogId == null) {
    //         // return Response.status(Response.Status.BAD_REQUEST).entity("blog id not found in path").build();
    //         return Uni.createFrom().item(Response.status(Response.Status.BAD_REQUEST).entity("blog id not found in path").build());
    //     }
    //     // return commentService.getAllCommentsFromBlog(blogId).createHttpResponse();

    //     return Uni.createFrom()
    //         .item(commentService.getAllCommentsFromBlog(blogId).createHttpResponse())
    //         .runSubscriptionOn(Infrastructure.getDefaultExecutor())
    //         .flatMap(response -> Uni.createFrom().item(response));
    // }
    ...
    // public Uni<Response> getSingleCommentFromBlogPost(@PathParam("blogId") Long blogId,
    ...
    //         return Uni.createFrom().item(Response.status(Response.Status.BAD_REQUEST).entity(MISSING_COMMENT_ID_IN_PATH_MESSAGE).build());
    //     }
    //     // return commentService.getSingleCommentFromBlog(blogId, commentId).createHttpResponse();

    //     return Uni.createFrom()
    //         .item(commentService.getSingleCommentFromBlog(blogId, commentId).createHttpResponse())
    //         .runSubscriptionOn(Infrastructure.getDefaultExecutor())
    //         .flatMap(response -> Uni.createFrom().item(response));
    // }
    ...
    // public Uni<Response> addCommentToBlogPost(@PathParam("blogId") Long blogId, @Valid CommentDTO commentDTO,
    ...
    //     return Uni.createFrom().item(commentDTO)
    //         .runSubscriptionOn(Infrastructure.getDefaultExecutor())
    //         .flatMap(comment -> Uni.createFrom().item(commentService.addCommentToBlog(blogId, comment)))
    //         .map(savedComment -> savedComment.createHttpResponse(uriInfo));
    // }
    ...
    // public Uni<Response> deleteCommentFromBlogPost(@PathParam("blogId") Long blogId,
    //         @PathParam("commentId") Long commentId) {
    //     if (blogId == null) {
    //         // return Response.status(Response.Status.BAD_REQUEST).entity(MISSING_BLOG_ID_IN_PATH_MESSAGE).build();
    //         return Uni.createFrom().item(Response.status(Response.Status.BAD_REQUEST).entity(MISSING_BLOG_ID_IN_PATH_MESSAGE).build());
    ...
    //     return Uni.createFrom()
    //         .item(commentService.deleteCommentFromBlog(blogId, commentId).createHttpResponse())
    //         .runSubscriptionOn(Infrastructure.getDefaultExecutor())
    //         .flatMap(response -> Uni.createFrom().item(response));
    // }
    ...
    // public Uni<Response> updateCommentOfBlogPost(@PathParam("blogId") Long blogId, @Valid CommentDTO commentDTO) {
    //     if (blogId == null) {
    //         // return Response.status(Response.Status.BAD_REQUEST).entity(MISSING_BLOG_ID_IN_PATH_MESSAGE).build();
    //         return Uni.createFrom().item(Response.status(Response.Status.BAD_REQUEST).entity(MISSING_BLOG_ID_IN_PATH_MESSAGE).build());
    //     }
    ...
    //     return Uni.createFrom().item(commentDTO)
    //         .runSubscriptionOn(Infrastructure.getDefaultExecutor())
    //         .flatMap(comment -> Uni.createFrom().item(commentService.updateCommentOfBlog(blogId, comment)))
    //         .map(updatedComment -> updatedComment.createHttpResponse());
    // }
}