...
public class CommentService extends ServiceBase {
    ...
    public Uni<List<CommentDTO>> getAllCommentsWithOptionalFiltering(Optional<String> searchString,
            Optional<Long> page) {
        ...
        return commentQuery.page(Page.ofSize(10))
                .list()
                .map(BncConverter::toCommentDtoCollection);
    ...
    //     try {
    //         Uni<BlogPost> blog = blogRepository.findById(blogId);
