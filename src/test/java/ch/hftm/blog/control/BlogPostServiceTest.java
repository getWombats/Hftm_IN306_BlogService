...
public class BlogPostServiceTest {
    ...
    public void setup() {
        ...
        Mockito.when(blogQueryMock.list())
                .thenReturn(List.of(new BlogPost(null, "title", "content", "author", Instant.now(), null, true, null)));
    ...
    void listingAndAddingBlog() {
        ...
        BlogPost blogPost = new BlogPost(1L, NEW_BLOG_TITLE, NEW_BLOG_CONTENT, NEW_BLOG_AUTHOR, Instant.now(), null,
                true, null);
    ...
    void deletingBlog() {
        ...
        BlogPost blogPost = new BlogPost(null, NEW_BLOG_TITLE, NEW_BLOG_CONTENT, NEW_BLOG_AUTHOR, Instant.now(), null,
                true, null);
        List<BlogPostDTO> blogs;
    ...
    void updatingBlog() {
        // Arrange
        BlogPostDTO updateBlogPost = new BlogPostDTO(1L, "Updated Blog title", NEW_BLOG_CONTENT, NEW_BLOG_AUTHOR, null,
                null, null, true);
